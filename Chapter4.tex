...
\begin{proof}
    \begin{align*}
        ...
        &= \bigboxplus_{(i,j) \in I \times J} p_i q_{i,j}  \cdot x_{i,j}\qedhere
    \end{align*}
\end{proof}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        &= \left(\bigboxplus_{i \in I} p_i \cdot x_{i}\right) \boxplus \left(\bigboxplus_{i \in I} q_i \cdot y_i\right)\qedhere
    \end{align*}
\end{proof}
...
\begin{proof}
    ...
    \begin{align*}
         ...
         &\equiv_b \left(\bigoplus_{i \in I} p_i \cdot e_i \seq f\right)\qedhere
    \end{align*}
\end{proof}
...
\begin{proof}[Proof of \Cref{c4:lem:coalg_on_quotient_left_dist}]
 ...
 \begin{itemize}
	...
	Once again, we apply \Cref{c4:lem:concrete_quotient} and obtain the following:
		$$
			(\funG [-]_{\equiv} \circ c)[b \seq \zero]_{\equiv} = \left\langle 0, \lambda a \ldotp [\zero] \right\rangle = (\funG [-]_{\equiv} \circ c)[\zero]_{\equiv}\qedhere
		$$
 \end{itemize}
\end{proof}
