...
\begin{align*}
     a \seq a^{[\frac{1}{4}]} &\equiv a \seq \left(a^{[\frac{1}{4}]} \seq a \right)\oplus_{\frac{1}{4}} \one \tag{$\dagger$}\\ 
     &\equiv \left(a \seq \left(a^{[\frac{1}{4}]}\seq a\right)\right) \oplus_{\frac{1}{4}} a \seq \one \tag{\textsf{D2}}\\
     &\equiv \left(a \seq \left(a^{[\frac{1}{4}]}\seq a\right)\right)\oplus_{\frac{1}{4}} a \tag{\textsf{S1}}\\
     &\equiv a \oplus_{\frac{3}{4}}\left(a \seq \left(a^{[\frac{1}{4}]}\seq a\right)\right)  \tag{\textsf{C3}}
\end{align*}
...
\begin{theorem}\label{c4:thm:unique_solutions}
    E  Every left-affine system of equations has a unique solution modulo the equivalence relation $\equiv$.
\end{theorem}
\begin{proof}
