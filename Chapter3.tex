...
\end{lemma}
\begin{proof}
	Let $\Delta = \{(e,e) \in \Expr\}$ be a diagonal relation. We define a relation ${R} \subseteq {\Expr \times \Expr}$, given by the following:
	\begin{align*}
...
\begin{proof}
	\begin{align*}
		...
		&\leq \max \left\{d^{m,k}(f,f'),d^{n,k}(g,g') \right\} \qquad
	\end{align*}
\end{proof}
