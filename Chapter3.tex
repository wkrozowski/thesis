...
\begin{theorem}[Quantitative soundness]\label{thm:soundness}
...
\begin{equation*}
\begin{gathered}
\tikzfig{unroll-merge-c-star-o}\\
\qquad\disteq{0}\quad\tikzfig{unroll-merge-c-star-o-1}\\
\qquad\disteq{0} \;\tikzfig{unroll-merge-c-star-o-2}\\
\qquad\disteq{0} \;\tikzfig{unroll-merge-c-star-o-3}
\end{gathered}
\end{equation*}
...
\begin{equation*}
\begin{gathered}
\tikzfig{unroll-merge-c-star-o-3}\\ \qquad \disteq{0} \;\tikzfig{unroll-merge-c-star-o-4} \\
\qquad \disteq{0} \;\tikzfig{unroll-merge-c-star-o-5}\\
\qquad\disteq{0} \;\tikzfig{merge-c-star-o}
\end{gathered}
\end{equation*}
...
\begin{lemma}\label{lem:merge-repr}
	...
	\begin{align*}
		\sem{\tikzfig{merge-cxd}} &= N \left( \langle s, t\rangle \right)
	\end{align*}
\end{lemma}
\begin{proof}
	\begin{align*}
		...
		&= N( \langle s,t[v_2/v_1] \rangle ; \langle \id_1, \id_1\rangle )\\
		&=N( \langle s , t \rangle ) \\
	\end{align*}
\end{proof}
